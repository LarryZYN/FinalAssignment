...
# Extracting unique launch sites
unique_launch_sites = spacex_df['Launch Site'].unique().tolist()
# Preparing options for the dropdown
...
# TASK 2: Callback function for `site-dropdown` to update the pie chart
@app.callback(
...
# TASK 4: Callback function for `site-dropdown` and `payload-slider` to update the scatter plot
@app.callback(
